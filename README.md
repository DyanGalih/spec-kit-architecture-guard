...
[![Version](https://img.shields.io/badge/version-1.0.8-22c55e)](extension.yml)
...
specify extension add architecture-guard --from \
  https://github.com/DyanGalih/spec-kit-architecture-guard/archive/refs/tags/v1.0.8.zip
```
