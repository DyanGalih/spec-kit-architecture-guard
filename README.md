...
[![Version](https://img.shields.io/badge/version-1.8.11-22c55e)](extension.yml)
...
```text
specify extension add architecture-guard --from https://github.com/DyanGalih/spec-kit-architecture-guard/archive/refs/tags/v1.8.11.zip
```
