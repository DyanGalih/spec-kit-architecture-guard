...
Generate `specs/system_context.md` as a compact offline fallback for Budgeted Architecture Context Retrieval. This file supplements active feature artifacts; it is not a canonical specification and must never replace the active `spec.md`, `plan.md`, `tasks.md`, security constraints, or constitutions.
